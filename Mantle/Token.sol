...
/**
 *
 * General-Purpose Token on Mantle utilising OpenZeppelin library
 *
 * powered by Mantle
 * verified on Mantle Testner Explorer 02.08.2023
 *
 */
...
contract GeneralToken is ERC20 {
    constructor() ERC20("General Token", "GNT") {
        _mint(msg.sender, 1_000_000 * 10 ** decimals()); // Mints 1 million tokens to the deployer
    }
}
